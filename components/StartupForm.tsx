    ...
    >
      ...
      <div data-color-mode="light">
        ...
        <MDEditor
          ...
          textareaProps={{
            placeholder:
              "Briefly describe your ideas and what problem it solves",
          }}
          previewOptions={{
      ...
      <Button
        type="submit"
        className="bg-[#EE2B69] border-[4px] border-black rounded-full p-5 min-h-[70px] w-full font-bold text-[18px] !important text-white"
        disabled={isPending}
      >
